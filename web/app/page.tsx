...
import HeaderChatbot from '@/components/header-chatbot'
import { 
  Receipt, 
  Users, 
  Smartphone, 
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              <Button 
                variant="outline" 
                className="border-2 border-purple-500 text-purple-600 hover:bg-purple-50 hover:text-purple-700 font-medium"
                onClick={() => setIsHeaderChatOpen(true)}
              >
      ...
      {/* Header Chatbot Modal */}
      {isHeaderChatOpen && (
        <HeaderChatbot onClose={() => setIsHeaderChatOpen(false)} />
      )}
