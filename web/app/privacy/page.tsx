            ...
            <Card className="mb-8">
              <CardContent className="pt-6 prose prose-blue max-w-none">
                ...
                <p className="text-gray-600 mb-4">
                  Welcome to Astric.ai (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;). We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our business automation platform.
                </p>
