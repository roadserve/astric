...
export default function BotBuilderPage() {
  ...
  const triggers = [
    { 
      ...
      configFields: [
        { name: 'contains', label: 'Message Contains (optional)', type: 'text', placeholder: 'keyword' }
      ]
    },
    { 
      id: 'keyword_match', 
    ...
    { 
      ...
      configFields: [
        { name: 'outside_hours', label: 'Outside Business Hours', type: 'checkbox' },
        { name: 'start_time', label: 'Start Time', type: 'time', placeholder: '09:00' },
        { name: 'end_time', label: 'End Time', type: 'time', placeholder: '18:00' }
      ]
    },
  ]
  ...
  const actions = [
    { 
      ...
      configFields: [
        ...
        { name: 'preview_url', label: 'Preview URLs', type: 'checkbox' }
      ]
    },
    { 
      id: 'send_template', 
      ...
      configFields: [
        ...
        { name: 'variables', label: 'Variables (JSON)', type: 'textarea', placeholder: '["John", "Doe"]' }
      ]
    },
    { 
      id: 'send_image', 
      ...
      configFields: [
        ...
        { name: 'caption', label: 'Caption (optional)', type: 'textarea', maxLength: 1024 }
      ]
    },
    { 
      id: 'add_tag', 
