...
export default function SettingsPage() {
  ...
  useEffect(() => {
    ...
    if (tab && ['organization', 'profile', 'notifications', 'security', 'billing', 'integrations'].includes(tab)) {
      setActiveTab(tab)
    }
  }, [searchParams])
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                          />
                          <p className="text-xs text-gray-500 mt-1">Optional (not required if you are already logged in).</p>
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-2">
                            New Password
                        ...
                        <Button className="bg-blue-600 hover:bg-blue-700" onClick={handleUpdatePassword} disabled={pwSaving}>
