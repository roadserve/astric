        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <p className="text-gray-700 mb-2">
              अगर आप technical नहीं हैं, तो <strong>&ldquo;Simple Wizard&rdquo;</strong> button से शुरू करें। 
          ...
          <div>
            ...
            <p className="text-gray-700">
              ...
              तो <strong>&ldquo;Advanced Editor&rdquo;</strong> use करें।
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700">
                &ldquo;अगर ऐसा हो तो वो करो&rdquo; type की logic बनाएं। जैसे: अगर payment 10,000 से ज्यादा हो 
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-3">
          <div>
            ...
            <p className="text-sm text-gray-700">
              एक complete automation process को &ldquo;workflow&rdquo; कहते हैं। जैसे पूरी email sending process 
              एक workflow है।
            </p>
          </div>
          ...
          <div>
            <strong>Node:</strong>
            <p className="text-sm text-gray-700">
              हर action को एक &ldquo;node&rdquo; कहते हैं। जैसे: &ldquo;Send Email&rdquo; एक node है, &ldquo;WhatsApp Message&rdquo; एक node है। 
          ...
          <div>
            ...
            <p className="text-sm text-gray-700">
              जब workflow run होता है उसे &ldquo;execution&rdquo; कहते हैं। आप execution logs में देख सकते हैं कि 
